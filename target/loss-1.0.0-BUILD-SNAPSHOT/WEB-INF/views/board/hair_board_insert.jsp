...
$(document).ready(function(){
	$('#hairBoardInsert').click(function(){
		...
		var form = $("#hairBoardInsertForm");
		form.attr("method", "post");
		form.attr("action", "<c:url value="/hairBoardInsert.do" />")
		form.submit();
	});
...
<form id="hairBoardInsertForm" name="hairBoardInsertForm" action="/hairBoardInsert.do" enctype="multipart/form-data">
<div class="container">
	<h3>게시판 글 쓰기</h3>
	<div class="jumbotron jumbotron-fluid">
		<div class="container">
				...
				<input class="btn btn-success pull-right" type="button" id="hairBoardInsert" name="hairBoardInsert" value="글 쓰기">
		</div>
	</div>
</div>
</form>
