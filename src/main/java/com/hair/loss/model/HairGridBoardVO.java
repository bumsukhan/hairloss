...
public class HairGridBoardVO
{
	...
	public String toString() {
		return "HairGridBoardVO [rnum=" + rnum + ", bnum=" + bnum + ", fnum=" + fnum + ", cnt=" + cnt + ", title="
				+ title + ", contents=" + contents + ", regdate=" + regdate + ", users_id=" + users_id + ", del_yn="
				+ del_yn + ", filecnt=" + filecnt + ", replycnt=" + replycnt + ", chknum=" + chknum + ", flag=" + flag
				+ ", bMinNum=" + bMinNum + ", bMaxNum=" + bMaxNum + ", uploadfile=" + uploadfile + ", startIndex="
				+ startIndex + ", cntPerPage=" + cntPerPage + ", curPage=" + curPage + "]";
	}
